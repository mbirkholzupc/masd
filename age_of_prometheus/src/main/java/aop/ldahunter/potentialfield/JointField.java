 ...
 */
package aop.ldahunter.potentialfield;
...
import aop.ldahunter.potentialfield.Evaluator;
import aop.ldahunter.potentialfield.FieldModel;
import aop.ldahunter.potentialfield.FoodModel;
...
public class JointField extends HashMap
{
	...
	final int w;
	final int range;
	final aop.ldahunter.potentialfield.Evaluator ev;
	final HashSet eaten;
	ISpaceObject myself;
	int myX;
	int myY;
	int round;
	final aop.ldahunter.potentialfield.FoodModel food;
	public final aop.ldahunter.potentialfield.FieldModel field;
